...
## Modules
1. **Global Compass:** Pre-flight checklist for every platform. Lives inside `docs/install/docker.md` under “Founder install clarity pack.”
...
Each chunk references the same underlying standards defined in `docs/install/phase4-protocols.md`, which makes it easy to cite when opening upstream issues and PRs.
